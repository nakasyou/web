...
<div bind:this={hellosDiv} class="text-4xl md:text-5xl font-bold flex gap-5 max-w-72 md:max-w-96 overflow-x-scroll break-keep text-nowrap whitespace-nowrap sleect-none touch-none">
  {#each strs as str, i}
